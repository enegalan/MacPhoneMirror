        ...
        VStack(spacing: 0) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 18) {
                    ...
                    guideStep(4, "Configure Pointer Devices", "With \(AppInfo.displayName) running, tap Devices > Bluetooth Devices. Choose \(AppInfo.displayName) or your Mac's Computer Name if that is what appears.")
